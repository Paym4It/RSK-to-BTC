...
// const mURL = 'https://mainnet.infura.io/v3/' + KEY2;
...
const getPublicKeyFromTransactionID = async (n, TxId) => {
    ...
    const rstransactionHash = await ethers.utils.resolveProperties(transactionHashData); // resolved transaction
    ...
    return [raw,msgHash,recoveredPubKey,recoveredAddress.toLowerCase()];
    
}

module.exports = {getPublicKeyFromTransactionID};